...
//    private static final KeyCodeAdapter instance = new KeyCodeAdapter();
     ...
     */
    private KeyCodeAdapter(Canvas adapterCanvas) {
        this.adaptorCanvas = adapterCanvas;
...
//                    e.printStackTrace();
     ...
     * @return instance
     */
    public static KeyCodeAdapter getInstance(Canvas adapterCanvas) {
        return new KeyCodeAdapter(adapterCanvas);
    }
}
