...
import hotsprings.scene.demo.AffineTransformDemo;
import hotsprings.scene.demo.BitmapFontDemo;
import hotsprings.scene.demo.Capabilities;
import hotsprings.scene.demo.ImageDemo;
import hotsprings.scene.demo.ImageStress;
import hotsprings.scene.demo.KeypadDemo;
import hotsprings.scene.demo.MovieclipDemo;
import hotsprings.scene.demo.MovieclipStress;
import hotsprings.scene.demo.Player1Demo;
import hotsprings.scene.demo.TextDemo;
import hotsprings.scene.demo.TouchDemo;
import hotsprings.scene.demo.game.GameMechanicTest;
